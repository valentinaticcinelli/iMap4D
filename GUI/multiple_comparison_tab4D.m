function StatMap_c=multiple_comparison_tab4D(obj,LMMmap,FixMap,StatMap,pathname)
...
%% to adjust this!!!
StatMap_c=imapLMMmcc4D(obj,StatMap,LMMmap,mccopt,FixMap);
...
if strcmp(answer_user,'yes')
    ...
    imapLMMdisplay4D(obj,StatMap_c,normalized,backgroundfile(2:end-1),cmap(2:end-1),colormaprange,distplot,pathname);
end
