function [Predictors_continuous_default,Predictors_categorical_default,Predictors_continuous,Predictors_categorical,counter,handles] = select_conditions4D(hObject,handles,counter)
...
r = {'Please select the column name of the following predictors:'};
...
rr = {'Subject','Trial','Eye_X','Eye_Y','Eye_Z','Duration'};
n_column = {'1','2','3','4','5','7'}; % by default the removed column
...
predictors_continuous_default  = columns(n_column(3:6))'; %default continuous conditions
idx_continuous_default = n_column(3:6);
